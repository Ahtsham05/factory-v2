        ...
        <div className="bg-white rounded-lg shadow-lg px-8 py-10 max-w-xl mx-auto">
          ...
          <div id="invoice-to-print" className="invoice">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center">
                <img
                  ...
                  alt="Logo"
                />
                <div className="text-gray-700 font-semibold text-lg">Your Weaving Factory</div>
              </div>
            ...
            <div className="border-t-2 border-gray-300 pt-8 mb-8">
              ...
              <div className="text-gray-700 mb-2">Please make checks payable to Your Weaving Factory and mail to:</div>
